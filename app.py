...
with st.container():
    ...
    # Add GCP Configuration options           
        ...
        if service == "Compute Engine":
            ...
            zone = st.selectbox("Zone", ["us-central1-a", "us-central1-b", "us-central1-c", "europe-west1-b", "europe-west1-c", "asia-northeast1-a"])
            ...
            zone = st.selectbox("Zone/Region", ["us-central1-a", "us-central1-b", "us-central1-c", "europe-west1-b", "europe-west1-c", "asia-northeast1-a"])
